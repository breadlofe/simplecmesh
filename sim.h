...
// ALL PARAMETERS AND STRUCTS IN THIS FILE THAT ARE ALSO IN /incl/simsys.h MUST MATCH THE VERSION IN simsys.h
// For example: struct YS_PACKETDATA
...
struct YS__PktData
{
   ...
   int *mesgptr;            /* Pointer the message for this packet                */
